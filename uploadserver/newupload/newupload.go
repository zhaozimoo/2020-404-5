...
func UploadHandler(w http.ResponseWriter, r *http.Request) {
	if r.Method == "GET" {
		...
		newFile, err := os.Create("/data/resourcecenter/" +"rec"+CreateCaptcha() + fileHeader.Filename)
		if err != nil {
		...
		// 重定向到这个请求
		http.Redirect(w, r, "http://zwfw.nmg.gov.cn/app/resourcecenterup/file/upload/suc", http.StatusFound)
...
func UploadSuccessHandler(w http.ResponseWriter, r *http.Request) {
	...
	_, _ = io.WriteString(w, "http://zwfw.nmg.gov.cn/app/resourcecenterdl/"+Filename[comma+pos:])
}
